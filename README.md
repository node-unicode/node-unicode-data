...
require('unicode-6.2.0/Line_Break/Alphabetic/code-points');
require('unicode-6.2.0/Line_Break/Alphabetic/symbols');
require('unicode-6.2.0/Line_Break/Alphabetic/regex');

require('unicode-6.2.0/Line_Break/Ambiguous/code-points');
require('unicode-6.2.0/Line_Break/Ambiguous/symbols');
require('unicode-6.2.0/Line_Break/Ambiguous/regex');

require('unicode-6.2.0/Line_Break/Break_After/code-points');
require('unicode-6.2.0/Line_Break/Break_After/symbols');
require('unicode-6.2.0/Line_Break/Break_After/regex');

require('unicode-6.2.0/Line_Break/Break_Before/code-points');
require('unicode-6.2.0/Line_Break/Break_Before/symbols');
require('unicode-6.2.0/Line_Break/Break_Before/regex');

require('unicode-6.2.0/Line_Break/Break_Both/code-points');
require('unicode-6.2.0/Line_Break/Break_Both/symbols');
require('unicode-6.2.0/Line_Break/Break_Both/regex');

require('unicode-6.2.0/Line_Break/Break_Symbols/code-points');
require('unicode-6.2.0/Line_Break/Break_Symbols/symbols');
require('unicode-6.2.0/Line_Break/Break_Symbols/regex');

require('unicode-6.2.0/Line_Break/Carriage_Return/code-points');
require('unicode-6.2.0/Line_Break/Carriage_Return/symbols');
require('unicode-6.2.0/Line_Break/Carriage_Return/regex');

require('unicode-6.2.0/Line_Break/Close_Parenthesis/code-points');
require('unicode-6.2.0/Line_Break/Close_Parenthesis/symbols');
require('unicode-6.2.0/Line_Break/Close_Parenthesis/regex');

require('unicode-6.2.0/Line_Break/Close_Punctuation/code-points');
require('unicode-6.2.0/Line_Break/Close_Punctuation/symbols');
require('unicode-6.2.0/Line_Break/Close_Punctuation/regex');

require('unicode-6.2.0/Line_Break/Combining_Mark/code-points');
require('unicode-6.2.0/Line_Break/Combining_Mark/symbols');
require('unicode-6.2.0/Line_Break/Combining_Mark/regex');

require('unicode-6.2.0/Line_Break/Complex_Context/code-points');
require('unicode-6.2.0/Line_Break/Complex_Context/symbols');
require('unicode-6.2.0/Line_Break/Complex_Context/regex');

require('unicode-6.2.0/Line_Break/Conditional_Japanese_Starter/code-points');
require('unicode-6.2.0/Line_Break/Conditional_Japanese_Starter/symbols');
require('unicode-6.2.0/Line_Break/Conditional_Japanese_Starter/regex');

require('unicode-6.2.0/Line_Break/Contingent_Break/code-points');
require('unicode-6.2.0/Line_Break/Contingent_Break/symbols');
require('unicode-6.2.0/Line_Break/Contingent_Break/regex');

require('unicode-6.2.0/Line_Break/Exclamation/code-points');
require('unicode-6.2.0/Line_Break/Exclamation/symbols');
require('unicode-6.2.0/Line_Break/Exclamation/regex');

require('unicode-6.2.0/Line_Break/Glue/code-points');
require('unicode-6.2.0/Line_Break/Glue/symbols');
require('unicode-6.2.0/Line_Break/Glue/regex');

require('unicode-6.2.0/Line_Break/H2/code-points');
require('unicode-6.2.0/Line_Break/H2/symbols');
require('unicode-6.2.0/Line_Break/H2/regex');

require('unicode-6.2.0/Line_Break/H3/code-points');
require('unicode-6.2.0/Line_Break/H3/symbols');
require('unicode-6.2.0/Line_Break/H3/regex');

require('unicode-6.2.0/Line_Break/Hebrew_Letter/code-points');
require('unicode-6.2.0/Line_Break/Hebrew_Letter/symbols');
require('unicode-6.2.0/Line_Break/Hebrew_Letter/regex');

require('unicode-6.2.0/Line_Break/Hyphen/code-points');
require('unicode-6.2.0/Line_Break/Hyphen/symbols');
require('unicode-6.2.0/Line_Break/Hyphen/regex');

require('unicode-6.2.0/Line_Break/Ideographic/code-points');
require('unicode-6.2.0/Line_Break/Ideographic/symbols');
require('unicode-6.2.0/Line_Break/Ideographic/regex');

require('unicode-6.2.0/Line_Break/Infix_Numeric/code-points');
require('unicode-6.2.0/Line_Break/Infix_Numeric/symbols');
require('unicode-6.2.0/Line_Break/Infix_Numeric/regex');

require('unicode-6.2.0/Line_Break/Inseparable/code-points');
require('unicode-6.2.0/Line_Break/Inseparable/symbols');
require('unicode-6.2.0/Line_Break/Inseparable/regex');

require('unicode-6.2.0/Line_Break/JL/code-points');
require('unicode-6.2.0/Line_Break/JL/symbols');
require('unicode-6.2.0/Line_Break/JL/regex');

require('unicode-6.2.0/Line_Break/JT/code-points');
require('unicode-6.2.0/Line_Break/JT/symbols');
require('unicode-6.2.0/Line_Break/JT/regex');

require('unicode-6.2.0/Line_Break/JV/code-points');
require('unicode-6.2.0/Line_Break/JV/symbols');
require('unicode-6.2.0/Line_Break/JV/regex');

require('unicode-6.2.0/Line_Break/Line_Feed/code-points');
require('unicode-6.2.0/Line_Break/Line_Feed/symbols');
require('unicode-6.2.0/Line_Break/Line_Feed/regex');

require('unicode-6.2.0/Line_Break/Mandatory_Break/code-points');
require('unicode-6.2.0/Line_Break/Mandatory_Break/symbols');
require('unicode-6.2.0/Line_Break/Mandatory_Break/regex');

require('unicode-6.2.0/Line_Break/Next_Line/code-points');
require('unicode-6.2.0/Line_Break/Next_Line/symbols');
require('unicode-6.2.0/Line_Break/Next_Line/regex');

require('unicode-6.2.0/Line_Break/Nonstarter/code-points');
require('unicode-6.2.0/Line_Break/Nonstarter/symbols');
require('unicode-6.2.0/Line_Break/Nonstarter/regex');

require('unicode-6.2.0/Line_Break/Numeric/code-points');
require('unicode-6.2.0/Line_Break/Numeric/symbols');
require('unicode-6.2.0/Line_Break/Numeric/regex');

require('unicode-6.2.0/Line_Break/Open_Punctuation/code-points');
require('unicode-6.2.0/Line_Break/Open_Punctuation/symbols');
require('unicode-6.2.0/Line_Break/Open_Punctuation/regex');

require('unicode-6.2.0/Line_Break/Postfix_Numeric/code-points');
require('unicode-6.2.0/Line_Break/Postfix_Numeric/symbols');
require('unicode-6.2.0/Line_Break/Postfix_Numeric/regex');

require('unicode-6.2.0/Line_Break/Prefix_Numeric/code-points');
require('unicode-6.2.0/Line_Break/Prefix_Numeric/symbols');
require('unicode-6.2.0/Line_Break/Prefix_Numeric/regex');

require('unicode-6.2.0/Line_Break/Quotation/code-points');
require('unicode-6.2.0/Line_Break/Quotation/symbols');
require('unicode-6.2.0/Line_Break/Quotation/regex');

require('unicode-6.2.0/Line_Break/Regional_Indicator/code-points');
require('unicode-6.2.0/Line_Break/Regional_Indicator/symbols');
require('unicode-6.2.0/Line_Break/Regional_Indicator/regex');

require('unicode-6.2.0/Line_Break/Space/code-points');
require('unicode-6.2.0/Line_Break/Space/symbols');
require('unicode-6.2.0/Line_Break/Space/regex');

require('unicode-6.2.0/Line_Break/Surrogate/code-points');
require('unicode-6.2.0/Line_Break/Surrogate/symbols');
require('unicode-6.2.0/Line_Break/Surrogate/regex');

require('unicode-6.2.0/Line_Break/Unknown/code-points');
require('unicode-6.2.0/Line_Break/Unknown/symbols');
require('unicode-6.2.0/Line_Break/Unknown/regex');

require('unicode-6.2.0/Line_Break/Word_Joiner/code-points');
require('unicode-6.2.0/Line_Break/Word_Joiner/symbols');
require('unicode-6.2.0/Line_Break/Word_Joiner/regex');

require('unicode-6.2.0/Line_Break/ZWSpace/code-points');
require('unicode-6.2.0/Line_Break/ZWSpace/symbols');
require('unicode-6.2.0/Line_Break/ZWSpace/regex');

// `Word_Break`:

require('unicode-6.2.0/Word_Break/ALetter/code-points');
require('unicode-6.2.0/Word_Break/ALetter/symbols');
require('unicode-6.2.0/Word_Break/ALetter/regex');

require('unicode-6.2.0/Word_Break/CR/code-points');
require('unicode-6.2.0/Word_Break/CR/symbols');
require('unicode-6.2.0/Word_Break/CR/regex');

require('unicode-6.2.0/Word_Break/Extend/code-points');
require('unicode-6.2.0/Word_Break/Extend/symbols');
require('unicode-6.2.0/Word_Break/Extend/regex');

require('unicode-6.2.0/Word_Break/ExtendNumLet/code-points');
require('unicode-6.2.0/Word_Break/ExtendNumLet/symbols');
require('unicode-6.2.0/Word_Break/ExtendNumLet/regex');

require('unicode-6.2.0/Word_Break/Format/code-points');
require('unicode-6.2.0/Word_Break/Format/symbols');
require('unicode-6.2.0/Word_Break/Format/regex');

require('unicode-6.2.0/Word_Break/Katakana/code-points');
require('unicode-6.2.0/Word_Break/Katakana/symbols');
require('unicode-6.2.0/Word_Break/Katakana/regex');

require('unicode-6.2.0/Word_Break/LF/code-points');
require('unicode-6.2.0/Word_Break/LF/symbols');
require('unicode-6.2.0/Word_Break/LF/regex');

require('unicode-6.2.0/Word_Break/MidLetter/code-points');
require('unicode-6.2.0/Word_Break/MidLetter/symbols');
require('unicode-6.2.0/Word_Break/MidLetter/regex');

require('unicode-6.2.0/Word_Break/MidNum/code-points');
require('unicode-6.2.0/Word_Break/MidNum/symbols');
require('unicode-6.2.0/Word_Break/MidNum/regex');

require('unicode-6.2.0/Word_Break/MidNumLet/code-points');
require('unicode-6.2.0/Word_Break/MidNumLet/symbols');
require('unicode-6.2.0/Word_Break/MidNumLet/regex');

require('unicode-6.2.0/Word_Break/Newline/code-points');
require('unicode-6.2.0/Word_Break/Newline/symbols');
require('unicode-6.2.0/Word_Break/Newline/regex');

require('unicode-6.2.0/Word_Break/Numeric/code-points');
require('unicode-6.2.0/Word_Break/Numeric/symbols');
require('unicode-6.2.0/Word_Break/Numeric/regex');

require('unicode-6.2.0/Word_Break/Other/code-points');
require('unicode-6.2.0/Word_Break/Other/symbols');
require('unicode-6.2.0/Word_Break/Other/regex');

require('unicode-6.2.0/Word_Break/Regional_Indicator/code-points');
require('unicode-6.2.0/Word_Break/Regional_Indicator/symbols');
require('unicode-6.2.0/Word_Break/Regional_Indicator/regex');
```
